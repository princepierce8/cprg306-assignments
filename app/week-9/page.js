...
export default function Page() {
    ...
    return (
        ...
        <h1 className="text-4xl font-bold mb-8">Week 9 - Authentication</h1>

        {user ? (
            <div className="text-center">
                <p className="mb-4">Welcome, {user.displayName || user.email}!</p>
                <div>
                    <Link href="/week-9/shopping-list" className="bg-green-400 hover:bg-green-500 px-6 font-bold rounded-2xl">
                    Go to Shopping List
                    </Link>
